...
const paths = {
  ...
  code: '<path d="m8 9-4 3 4 3"/><path d="m16 9 4 3-4 3"/><path d="M14 4l-4 16"/>',
  image: '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9" r="1.5"/><path d="m21 15-4.5-4.5L6 21"/>',
  ...
  prev: '<path d="m18 5-8 7 8 7Z"/><path d="M6 5v14"/>',
  next: '<path d="m6 5 8 7-8 7Z"/><path d="M18 5v14"/>',
  ...
  weibo: '<circle cx="12" cy="12" r="9"/><path d="M8.5 10.5c.8-1.4 2.3-2 3.5-1.2"/><path d="M7.5 14.5c1.6-1.2 4.2-1.2 6 0"/><circle cx="12" cy="12" r="1.6"/>',
  bilibili: '<rect x="2.5" y="7" width="19" height="13" rx="2.5"/><path d="M8 3l4 3.5L16 3"/><circle cx="9" cy="13" r="1"/><circle cx="15" cy="13" r="1"/>',
  ...
  quote: '<path d="M3 21c3 0 7-1 7-8V5c0-1.5-1-2.5-2.5-2.5S4 3.5 4 5v3h4v8H3v5Z"/><path d="M14 21c3 0 7-1 7-8V5c0-1.5-1-2.5-2.5-2.5S16 3.5 16 5v3h4v8h-5v5Z"/>'
}
